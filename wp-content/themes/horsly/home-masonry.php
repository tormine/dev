...
//$query_one = new WP_Query();

//if ($query_one->have_posts()) : while ($query_one->have_posts()) : $query_one->the_post(); 
...
foreach((get_the_category()) as $category) { 
   $lwcategory = strtolower($category->slug);
   echo '<div class="category-title-'. $lwcategory .'">';
	
	} 
	
	
	?>	
     <div class="category-title"> <p>
    ...
    <div class="brick-header">
        <div class="thumb-holder">
            <div class="masonry-actionbar">
                ...
                <?php } else { ?>
                <a class="btn btn-mini" href="<?php echo home_url('/story-settings/'); ?>?i=<?php the_ID(); ?>"><i class="fa fa-edit"> </i><?php _e('', 'ipin'); ?></a>
                <?php } ?>
        ...
        <div class="masonry-meta masonry-meta-comment-likes text-align-center">
            ...
            if ($likes_number == '' || $likes_number == '0') {
                ...
                echo '<span id="likes-count-' . $post->ID . '" class="likes-count">1 ' . __('<i class="fa fa-heart"></i>', 'ipin') . '</span>' ;
            } else {
        ...
        <div class="masonry-actionbar-mobile">
            ...
            <?php } else { ?>
            <a class="btn btn-small" href="<?php echo home_url('/story-settings/'); ?>?i=<?php the_ID(); ?>"><i class="fa fa-edit"></i><?php _e('', 'ipin'); ?></a>
            <?php } ?>
